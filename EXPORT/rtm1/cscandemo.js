export default function Engine() {
	...
	RuntimeEnvironment: function (Module, exposedLibs) {
		...
		var DYNAMIC_BASE = 7180496,
			DYNAMICTOP_PTR = 1937424;
		...
		var ASM_CONSTS = [function () {
			...
			_audioDriver_scriptNode.onaudioprocess = function (audioProcessingEvent) {
				...
				var internalBuffer = HEAPF32.subarray(INTERNAL_BUFFER_PTR / HEAPF32.BYTES_PER_ELEMENT, INTERNAL_BUFFER_PTR / HEAPF32.BYTES_PER_ELEMENT + output.length * output.numberOfChannels);
			...
			if (_audioDriver_audioContext.resume) _audioDriver_audioContext.resume()
		}, function () {
			...
			if (navigator.mediaDevices.getUserMedia) {
				...
				navigator.getUserMedia({
					"audio": true
				}, gotMediaInput, gotMediaInputError)
			}
		}, function () {
			...
			(canvas.requestFullscreen || canvas.msRequestFullscreen || canvas.mozRequestFullScreen || canvas.mozRequestFullscreen || canvas.webkitRequestFullscreen).call(canvas)
		}, function () {
			...
			channel.onmessage = function (event) {
				...
				ccall("_emrtc_on_ch_message", "void", ["number", "number", "number", "number"], [c_ptr, out, len, is_string]);
				Module._free(out)
			}
		}, function ($0) {
			var dict = Module.IDHandler.get($0);
			...
			conn.onicecandidate = function (event) {
				...
				ccall("_emrtc_on_ice_candidate", "void", ["number", "string", "number", "string"], [c_ptr, c.sdpMid, c.sdpMLineIndex, c.candidate])
			};
			conn.ondatachannel = function (evt) {
				...
				var id = Module.IDHandler.add({
					"channel": evt.channel,
					"ptr": null
				});
				ccall("_emrtc_emit_channel", "void", ["number", "number"], [c_ptr, id])
			};
			dict["conn"] = conn
		}, function ($0) {
			var dict = Module.IDHandler.get($0);
			...
			var onCreated = function (offer) {
				ccall("_emrtc_session_description_created", "void", ["number", "string", "string"], [c_ptr, offer.type, offer.sdp])
			};
			...
			socket.addEventListener("open", function (event) {
				...
				ccall("_esws_on_connect", "void", ["number", "string"], [c_ptr, socket.protocol])
			});
			socket.addEventListener("message", function (event) {
				...
				var out = Module._malloc(len);
				Module.HEAPU8.set(buffer, out);
				ccall("_esws_on_message", "void", ["number", "number", "number", "number"], [c_ptr, out, len, is_string]);
				Module._free(out)
			});
		...
		var ___tm_current = 1937472;
		var ___tm_timezone = (stringToUTF8("GMT", 1937520, 4), 1937520);
		...
		var asmLibraryArg = {
			...
			"Tb": _dlopen,
			"Qb": _dlsym,
			"Cb": _eglGetProcAddress,
			"y": _emscripten_asm_const_iii,
			"Hb": _emscripten_enter_soft_fullscreen,
			"li": _emscripten_exit_fullscreen,
			"wb": _emscripten_exit_pointerlock,
			"mb": _emscripten_exit_soft_fullscreen,
			"hb": _emscripten_get_canvas_element_size,
			"ii": _emscripten_get_element_css_size,
			"xi": _emscripten_get_fullscreen_status,
			"qh": _emscripten_get_gamepad_status,
			"Bh": _emscripten_get_num_gamepads,
			"Mh": _emscripten_get_pointerlock_status,
			"lh": _emscripten_glActiveTexture,
			"kh": _emscripten_glAttachShader,
			"_d": _emscripten_glBeginQuery,
			"Dh": _emscripten_glBeginQueryEXT,
			"Bd": _emscripten_glBeginTransformFeedback,
			"jh": _emscripten_glBindAttribLocation,
			"ih": _emscripten_glBindBuffer,
			"yd": _emscripten_glBindBufferBase,
			"zd": _emscripten_glBindBufferRange,
			"hh": _emscripten_glBindFramebuffer,
			"gh": _emscripten_glBindRenderbuffer,
			"Fc": _emscripten_glBindSampler,
			"eh": _emscripten_glBindTexture,
			"xc": _emscripten_glBindTransformFeedback,
			"Hd": _emscripten_glBindVertexArray,
			"uh": _emscripten_glBindVertexArrayOES,
			"dh": _emscripten_glBlendColor,
			"ch": _emscripten_glBlendEquation,
			"bh": _emscripten_glBlendEquationSeparate,
			"ah": _emscripten_glBlendFunc,
			"$g": _emscripten_glBlendFuncSeparate,
			"Md": _emscripten_glBlitFramebuffer,
			"_g": _emscripten_glBufferData,
			"Zg": _emscripten_glBufferSubData,
			"Yg": _emscripten_glCheckFramebufferStatus,
			"Xg": _emscripten_glClear,
			"ad": _emscripten_glClearBufferfi,
			"bd": _emscripten_glClearBufferfv,
			"dd": _emscripten_glClearBufferiv,
			"cd": _emscripten_glClearBufferuiv,
			"Vg": _emscripten_glClearColor,
			"Ug": _emscripten_glClearDepthf,
			"Tg": _emscripten_glClearStencil,
			"Oc": _emscripten_glClientWaitSync,
			"Sg": _emscripten_glColorMask,
			"Rg": _emscripten_glCompileShader,
			"Qg": _emscripten_glCompressedTexImage2D,
			"ee": _emscripten_glCompressedTexImage3D,
			"Pg": _emscripten_glCompressedTexSubImage2D,
			"de": _emscripten_glCompressedTexSubImage3D,
			"_c": _emscripten_glCopyBufferSubData,
			"Og": _emscripten_glCopyTexImage2D,
			"Ng": _emscripten_glCopyTexSubImage2D,
			"fe": _emscripten_glCopyTexSubImage3D,
			"Mg": _emscripten_glCreateProgram,
			...
			"be": _emscripten_glDeleteQueries,
			"Fh": _emscripten_glDeleteQueriesEXT,
			"Fg": _emscripten_glDeleteRenderbuffers,
			"Hc": _emscripten_glDeleteSamplers,
			"Eg": _emscripten_glDeleteShader,
			"Pc": _emscripten_glDeleteSync,
			"Dg": _emscripten_glDeleteTextures,
			"wc": _emscripten_glDeleteTransformFeedbacks,
			"Gd": _emscripten_glDeleteVertexArrays,
			"th": _emscripten_glDeleteVertexArraysOES,
			...
			"Tc": _emscripten_glDrawArraysInstanced,
			"oh": _emscripten_glDrawArraysInstancedANGLE,
			"fc": _emscripten_glDrawArraysInstancedARB,
			"oe": _emscripten_glDrawArraysInstancedEXT,
			"gc": _emscripten_glDrawArraysInstancedNV,
			"Ud": _emscripten_glDrawBuffers,
			"me": _emscripten_glDrawBuffersEXT,
			"ph": _emscripten_glDrawBuffersWEBGL,
			"ug": _emscripten_glDrawElements,
			"Sc": _emscripten_glDrawElementsInstanced,
			"nh": _emscripten_glDrawElementsInstancedANGLE,
			"dc": _emscripten_glDrawElementsInstancedARB,
			"ec": _emscripten_glDrawElementsInstancedEXT,
			"ne": _emscripten_glDrawElementsInstancedNV,
			"ie": _emscripten_glDrawRangeElements,
			"tg": _emscripten_glEnable,
			"sg": _emscripten_glEnableVertexAttribArray,
			"Zd": _emscripten_glEndQuery,
			"Ch": _emscripten_glEndQueryEXT,
			"Ad": _emscripten_glEndTransformFeedback,
			"Rc": _emscripten_glFenceSync,
			"rg": _emscripten_glFinish,
			"qg": _emscripten_glFlush,
			"Id": _emscripten_glFlushMappedBufferRange,
			"ng": _emscripten_glFramebufferRenderbuffer,
			"mg": _emscripten_glFramebufferTexture2D,
			"Kd": _emscripten_glFramebufferTextureLayer,
			"lg": _emscripten_glFrontFace,
			"kg": _emscripten_glGenBuffers,
			"ig": _emscripten_glGenFramebuffers,
			"ce": _emscripten_glGenQueries,
			"Gh": _emscripten_glGenQueriesEXT,
			"hg": _emscripten_glGenRenderbuffers,
			"Ic": _emscripten_glGenSamplers,
			"gg": _emscripten_glGenTextures,
			"vc": _emscripten_glGenTransformFeedbacks,
			"Ed": _emscripten_glGenVertexArrays,
			"sh": _emscripten_glGenVertexArraysOES,
			"jg": _emscripten_glGenerateMipmap,
			"fg": _emscripten_glGetActiveAttrib,
			"eg": _emscripten_glGetActiveUniform,
			"Vc": _emscripten_glGetActiveUniformBlockName,
			"Wc": _emscripten_glGetActiveUniformBlockiv,
			"Yc": _emscripten_glGetActiveUniformsiv,
			"cg": _emscripten_glGetAttachedShaders,
			"bg": _emscripten_glGetAttribLocation,
			"ag": _emscripten_glGetBooleanv,
			"Jc": _emscripten_glGetBufferParameteri64v,
			"$f": _emscripten_glGetBufferParameteriv,
			"Vd": _emscripten_glGetBufferPointerv,
			"_f": _emscripten_glGetError,
			"Zf": _emscripten_glGetFloatv,
			"md": _emscripten_glGetFragDataLocation,
			"Yf": _emscripten_glGetFramebufferAttachmentParameteriv,
			"Kc": _emscripten_glGetInteger64i_v,
			"Mc": _emscripten_glGetInteger64v,
			"Cd": _emscripten_glGetIntegeri_v,
			"Xf": _emscripten_glGetIntegerv,
			"jc": _emscripten_glGetInternalformativ,
			"rc": _emscripten_glGetProgramBinary,
			"Vf": _emscripten_glGetProgramInfoLog,
			"Wf": _emscripten_glGetProgramiv,
			"wh": _emscripten_glGetQueryObjecti64vEXT,
			"yh": _emscripten_glGetQueryObjectivEXT,
			"vh": _emscripten_glGetQueryObjectui64vEXT,
			"Xd": _emscripten_glGetQueryObjectuiv,
			"xh": _emscripten_glGetQueryObjectuivEXT,
			"Yd": _emscripten_glGetQueryiv,
			"zh": _emscripten_glGetQueryivEXT,
			"Tf": _emscripten_glGetRenderbufferParameteriv,
			"zc": _emscripten_glGetSamplerParameterfv,
			"Ac": _emscripten_glGetSamplerParameteriv,
			"Rf": _emscripten_glGetShaderInfoLog,
			"Qf": _emscripten_glGetShaderPrecisionFormat,
			"Pf": _emscripten_glGetShaderSource,
			"Sf": _emscripten_glGetShaderiv,
			"Of": _emscripten_glGetString,
			"$c": _emscripten_glGetStringi,
			"Lc": _emscripten_glGetSynciv,
			"Nf": _emscripten_glGetTexParameterfv,
			"Mf": _emscripten_glGetTexParameteriv,
			"wd": _emscripten_glGetTransformFeedbackVarying,
			"Xc": _emscripten_glGetUniformBlockIndex,
			"Zc": _emscripten_glGetUniformIndices,
			"If": _emscripten_glGetUniformLocation,
			"Lf": _emscripten_glGetUniformfv,
			"Kf": _emscripten_glGetUniformiv,
			"nd": _emscripten_glGetUniformuiv,
			"td": _emscripten_glGetVertexAttribIiv,
			"sd": _emscripten_glGetVertexAttribIuiv,
			"Ff": _emscripten_glGetVertexAttribPointerv,
			"Hf": _emscripten_glGetVertexAttribfv,
			"Gf": _emscripten_glGetVertexAttribiv,
			"Ef": _emscripten_glHint,
			"oc": _emscripten_glInvalidateFramebuffer,
			"mc": _emscripten_glInvalidateSubFramebuffer,
			"Df": _emscripten_glIsBuffer,
			"Cf": _emscripten_glIsEnabled,
			"Bf": _emscripten_glIsFramebuffer,
			"Af": _emscripten_glIsProgram,
			"ae": _emscripten_glIsQuery,
			"Eh": _emscripten_glIsQueryEXT,
			"zf": _emscripten_glIsRenderbuffer,
			"Gc": _emscripten_glIsSampler,
			"xf": _emscripten_glIsShader,
			"Qc": _emscripten_glIsSync,
			"wf": _emscripten_glIsTexture,
			"uc": _emscripten_glIsTransformFeedback,
			"Dd": _emscripten_glIsVertexArray,
			"rh": _emscripten_glIsVertexArrayOES,
			"vf": _emscripten_glLineWidth,
			"uf": _emscripten_glLinkProgram,
			"Jd": _emscripten_glMapBufferRange,
			"tc": _emscripten_glPauseTransformFeedback,
			"tf": _emscripten_glPixelStorei,
			"sf": _emscripten_glPolygonOffset,
			"qc": _emscripten_glProgramBinary,
			"pc": _emscripten_glProgramParameteri,
			"Ah": _emscripten_glQueryCounterEXT,
			"je": _emscripten_glReadBuffer,
			"rf": _emscripten_glReadPixels,
			"qf": _emscripten_glReleaseShaderCompiler,
			"pf": _emscripten_glRenderbufferStorage,
			"Ld": _emscripten_glRenderbufferStorageMultisample,
			"sc": _emscripten_glResumeTransformFeedback,
			"of": _emscripten_glSampleCoverage,
			"Cc": _emscripten_glSamplerParameterf,
			"Bc": _emscripten_glSamplerParameterfv,
			"Ec": _emscripten_glSamplerParameteri,
			"Dc": _emscripten_glSamplerParameteriv,
			"mf": _emscripten_glScissor,
			"lf": _emscripten_glShaderBinary,
			"kf": _emscripten_glShaderSource,
			"jf": _emscripten_glStencilFunc,
			"hf": _emscripten_glStencilFuncSeparate,
			"gf": _emscripten_glStencilMask,
			"ff": _emscripten_glStencilMaskSeparate,
			"ef": _emscripten_glStencilOp,
			"df": _emscripten_glStencilOpSeparate,
			"cf": _emscripten_glTexImage2D,
			"he": _emscripten_glTexImage3D,
			"af": _emscripten_glTexParameterf,
			"$e": _emscripten_glTexParameterfv,
			"_e": _emscripten_glTexParameteri,
			"Ze": _emscripten_glTexParameteriv,
			"lc": _emscripten_glTexStorage2D,
			"kc": _emscripten_glTexStorage3D,
			"Ye": _emscripten_glTexSubImage2D,
			"ge": _emscripten_glTexSubImage3D,
			"xd": _emscripten_glTransformFeedbackVaryings,
			"Xe": _emscripten_glUniform1f,
			"We": _emscripten_glUniform1fv,
			"Ve": _emscripten_glUniform1i,
			"Ue": _emscripten_glUniform1iv,
			"ld": _emscripten_glUniform1ui,
			"hd": _emscripten_glUniform1uiv,
			"Te": _emscripten_glUniform2f,
			"Re": _emscripten_glUniform2fv,
			"Qe": _emscripten_glUniform2i,
			"Pe": _emscripten_glUniform2iv,
			"kd": _emscripten_glUniform2ui,
			"gd": _emscripten_glUniform2uiv,
			"Oe": _emscripten_glUniform3f,
			"Ne": _emscripten_glUniform3fv,
			"Me": _emscripten_glUniform3i,
			"Le": _emscripten_glUniform3iv,
			"jd": _emscripten_glUniform3ui,
			"fd": _emscripten_glUniform3uiv,
			"Ke": _emscripten_glUniform4f,
			"Je": _emscripten_glUniform4fv,
			"Ie": _emscripten_glUniform4i,
			"Ge": _emscripten_glUniform4iv,
			"id": _emscripten_glUniform4ui,
			"ed": _emscripten_glUniform4uiv,
			"Uc": _emscripten_glUniformBlockBinding,
			"Fe": _emscripten_glUniformMatrix2fv,
			"Td": _emscripten_glUniformMatrix2x3fv,
			"Rd": _emscripten_glUniformMatrix2x4fv,
			"Ee": _emscripten_glUniformMatrix3fv,
			"Sd": _emscripten_glUniformMatrix3x2fv,
			"Od": _emscripten_glUniformMatrix3x4fv,
			"De": _emscripten_glUniformMatrix4fv,
			"Pd": _emscripten_glUniformMatrix4x2fv,
			"Nd": _emscripten_glUniformMatrix4x3fv,
			"Wd": _emscripten_glUnmapBuffer,
			"Ce": _emscripten_glUseProgram,
			"Be": _emscripten_glValidateProgram,
			"Ae": _emscripten_glVertexAttrib1f,
			"ze": _emscripten_glVertexAttrib1fv,
			"ye": _emscripten_glVertexAttrib2f,
			"xe": _emscripten_glVertexAttrib2fv,
			"ve": _emscripten_glVertexAttrib3f,
			"ue": _emscripten_glVertexAttrib3fv,
			"te": _emscripten_glVertexAttrib4f,
			"se": _emscripten_glVertexAttrib4fv,
			"yc": _emscripten_glVertexAttribDivisor,
			"mh": _emscripten_glVertexAttribDivisorANGLE,
			"hc": _emscripten_glVertexAttribDivisorARB,
			"pe": _emscripten_glVertexAttribDivisorEXT,
			"ic": _emscripten_glVertexAttribDivisorNV,
			"rd": _emscripten_glVertexAttribI4i,
			"pd": _emscripten_glVertexAttribI4iv,
			"qd": _emscripten_glVertexAttribI4ui,
			"od": _emscripten_glVertexAttribI4uiv,
			"vd": _emscripten_glVertexAttribIPointer,
			"re": _emscripten_glVertexAttribPointer,
			"qe": _emscripten_glViewport,
			"Nc": _emscripten_glWaitSync,
			"G": _emscripten_longjmp,
			"Hh": _emscripten_memcpy_big,
			"oi": _emscripten_request_fullscreen_strategy,
			"Xh": _emscripten_request_pointerlock,
			"Ih": _emscripten_resize_heap,
			"ud": _emscripten_sample_gamepad_data,
			"Lb": _emscripten_set_canvas_element_size,
			"ke": _emscripten_set_fullscreenchange_callback_on_thread,
			"$d": _emscripten_set_gamepadconnected_callback_on_thread,
			"Qd": _emscripten_set_gamepaddisconnected_callback_on_thread,
			"Se": _emscripten_set_keydown_callback_on_thread,
			"He": _emscripten_set_keypress_callback_on_thread,
			"we": _emscripten_set_keyup_callback_on_thread,
			"Fd": _emscripten_set_main_loop,
			"og": _emscripten_set_mousedown_callback_on_thread,
			"Ag": _emscripten_set_mousemove_callback_on_thread,
			"dg": _emscripten_set_mouseup_callback_on_thread,
			"bf": _emscripten_set_touchcancel_callback_on_thread,
			"nf": _emscripten_set_touchend_callback_on_thread,
			"yf": _emscripten_set_touchmove_callback_on_thread,
			"Jf": _emscripten_set_touchstart_callback_on_thread,
			"Uf": _emscripten_set_wheel_callback_on_thread,
			"Wg": _emscripten_webgl_create_context,
			"fh": _emscripten_webgl_init_context_attributes,
			"Lg": _emscripten_webgl_make_context_current,
			"Nh": _environ_get,
			"Oh": _environ_sizes_get,
			"$b": _exit,
			"ya": _fd_close,
			"fi": _fd_write,
			"cb": _gai_strerror,
			...
			"S": _glColorMask,
			"Xa": _glCompileShader,
			"Kb": _glCompressedTexImage2D,
			"si": _glCompressedTexImage3D,
			"ti": _glCompressedTexSubImage2D,
			"lb": _glCompressedTexSubImage3D,
			"ri": _glCopyBufferSubData,
			"eb": _glCopyTexSubImage2D,
			"Gb": _glCreateProgram,
			"Za": _glCreateShader,
			"Ba": _glCullFace,
			"P": _glDeleteBuffers,
			...
			"Jb": _glFramebufferTextureLayer,
			"Mb": _glFrontFace,
			"F": _glGenBuffers,
			"I": _glGenFramebuffers,
			"pa": _glGenRenderbuffers,
			"B": _glGenTextures,
			"ba": _glGenVertexArrays,
			"Y": _glGenerateMipmap,
			"pi": _glGetFloatv,
			"ta": _glGetIntegerv,
			"Db": _glGetProgramInfoLog,
			"Ua": _glGetProgramiv,
			"Wa": _glGetShaderInfoLog,
			"za": _glGetShaderiv,
			"Ra": _glGetString,
			"qi": _glGetStringi,
			"mi": _glGetUniformBlockIndex,
			"Da": _glGetUniformLocation,
			"vi": _glInvalidateFramebuffer,
			"Eb": _glLinkProgram,
			"sa": _glPixelStorei,
			"va": _glReadBuffer,
			"kb": _glReadPixels,
			"oa": _glRenderbufferStorage,
			"Na": _glRenderbufferStorageMultisample,
			"da": _glScissor,
			"Ya": _glShaderSource,
			"z": _glTexImage2D,
			"Pa": _glTexImage3D,
			...
			"Oa": _glTexSubImage2D,
			"_a": _glTexSubImage3D,
			"ni": _glTransformFeedbackVaryings,
			"g": _glUniform1f,
			"l": _glUniform1i,
			"nb": _glUniform1iv,
			"Ib": _glUniform1ui,
			...
			"v": _glUniform4fv,
			"Fa": _glUniform4i,
			"ki": _glUniformBlockBinding,
			"Bb": _glUniformMatrix2fv,
			"Ab": _glUniformMatrix3fv,
			"h": _glUniformMatrix4fv,
			"ha": _glUseProgram,
			"t": _glVertexAttrib4f,
			"T": _glVertexAttrib4fv,
			"C": _glVertexAttribDivisor,
			"$a": _glVertexAttribI4ui,
			"Ia": _glVertexAttribIPointer,
			"d": _glVertexAttribPointer,
			"x": _glViewport,
			"rb": _gmtime,
			"yi": _godot_xhr_free,
			"_b": _godot_xhr_get_ready_state,
			"Ai": _godot_xhr_get_response,
			"Rb": _godot_xhr_get_response_headers,
			"Yb": _godot_xhr_get_response_headers_length,
			"Ob": _godot_xhr_get_response_length,
			"nc": _godot_xhr_get_status,
			"zi": _godot_xhr_new,
			"Nb": _godot_xhr_open,
			"ob": _godot_xhr_reset,
			"pg": _godot_xhr_send_data,
			"le": _godot_xhr_send_string,
			"ji": _godot_xhr_set_request_header,
			"ac": _inet_addr,
			"tb": invoke_i,
			"la": invoke_ii,
			"ka": invoke_iii,
		...
		var __emrtc_on_ice_candidate = Module["__emrtc_on_ice_candidate"] = function () {
			return Module["asm"]["Ui"].apply(null, arguments)
		};
		var __emrtc_session_description_created = Module["__emrtc_session_description_created"] = function () {
			return Module["asm"]["Vi"].apply(null, arguments)
		};
		var __emrtc_on_connection_state_changed = Module["__emrtc_on_connection_state_changed"] = function () {
...
(function () {
	...
	function loadXHR(resolve, reject, file, tracker) {
		if (file.substr(-5) === '.wasm' || file.substr(-4) === '.pck') {
			file += '.gz';
			var resolve_orig = resolve;
			resolve = function (xhr) {
				return resolve_orig(xhr.responseURL.substr(-3) === '.gz' ? {
					response: pako.inflate(xhr.response),

var Engine = {
	RuntimeEnvironment: function (Module, exposedLibs) {
		...
		var DYNAMIC_BASE = 7172144,
			DYNAMICTOP_PTR = 1929072;
		...
		var ___tm_current = 1929120;
		var ___tm_timezone = (stringToUTF8("GMT", 1929168, 4), 1929168);
		...
		var asmLibraryArg = {
			...
			"ni": _emscripten_exit_fullscreen,
			"wb": _emscripten_exit_pointerlock,
			"nb": _emscripten_exit_soft_fullscreen,
			"ib": _emscripten_get_canvas_element_size,
			"ei": _emscripten_get_element_css_size,
			"yi": _emscripten_get_fullscreen_status,
			"hh": _emscripten_get_gamepad_status,
			"ji": _emscripten_get_now,
			"sh": _emscripten_get_num_gamepads,
			"Dh": _emscripten_get_pointerlock_status,
			"mh": _emscripten_glActiveTexture,
			"lh": _emscripten_glAttachShader,
			"$d": _emscripten_glBeginQuery,
			"Eh": _emscripten_glBeginQueryEXT,
			"Cd": _emscripten_glBeginTransformFeedback,
			"kh": _emscripten_glBindAttribLocation,
			"jh": _emscripten_glBindBuffer,
			"zd": _emscripten_glBindBufferBase,
			"Ad": _emscripten_glBindBufferRange,
			"ih": _emscripten_glBindFramebuffer,
			"gh": _emscripten_glBindRenderbuffer,
			"Fc": _emscripten_glBindSampler,
			"fh": _emscripten_glBindTexture,
			"xc": _emscripten_glBindTransformFeedback,
			"Id": _emscripten_glBindVertexArray,
			"vh": _emscripten_glBindVertexArrayOES,
			"eh": _emscripten_glBlendColor,
			"dh": _emscripten_glBlendEquation,
			"ch": _emscripten_glBlendEquationSeparate,
			"bh": _emscripten_glBlendFunc,
			"ah": _emscripten_glBlendFuncSeparate,
			"Nd": _emscripten_glBlitFramebuffer,
			...
			"Wg": _emscripten_glClearColor,
			"Vg": _emscripten_glClearDepthf,
			"Ug": _emscripten_glClearStencil,
			"Oc": _emscripten_glClientWaitSync,
			"Tg": _emscripten_glColorMask,
			"Sg": _emscripten_glCompileShader,
			"Rg": _emscripten_glCompressedTexImage2D,
			"fe": _emscripten_glCompressedTexImage3D,
			"Qg": _emscripten_glCompressedTexSubImage2D,
			"ee": _emscripten_glCompressedTexSubImage3D,
			"_c": _emscripten_glCopyBufferSubData,
			"Pg": _emscripten_glCopyTexImage2D,
			"Og": _emscripten_glCopyTexSubImage2D,
			"ge": _emscripten_glCopyTexSubImage3D,
			"Mg": _emscripten_glCreateProgram,
			"Lg": _emscripten_glCreateShader,
			"Kg": _emscripten_glCullFace,
			"Jg": _emscripten_glDeleteBuffers,
			"Ig": _emscripten_glDeleteFramebuffers,
			"Hg": _emscripten_glDeleteProgram,
			"ce": _emscripten_glDeleteQueries,
			"Gh": _emscripten_glDeleteQueriesEXT,
			"Gg": _emscripten_glDeleteRenderbuffers,
			"Hc": _emscripten_glDeleteSamplers,
			"Fg": _emscripten_glDeleteShader,
			"Pc": _emscripten_glDeleteSync,
			"Eg": _emscripten_glDeleteTextures,
			"wc": _emscripten_glDeleteTransformFeedbacks,
			"Gd": _emscripten_glDeleteVertexArrays,
			"uh": _emscripten_glDeleteVertexArraysOES,
			"Dg": _emscripten_glDepthFunc,
			"Bg": _emscripten_glDepthMask,
			"Ag": _emscripten_glDepthRangef,
			"zg": _emscripten_glDetachShader,
			"yg": _emscripten_glDisable,
			"xg": _emscripten_glDisableVertexAttribArray,
			"wg": _emscripten_glDrawArrays,
			"Tc": _emscripten_glDrawArraysInstanced,
			"ph": _emscripten_glDrawArraysInstancedANGLE,
			"fc": _emscripten_glDrawArraysInstancedARB,
			"pe": _emscripten_glDrawArraysInstancedEXT,
			"gc": _emscripten_glDrawArraysInstancedNV,
			"Vd": _emscripten_glDrawBuffers,
			"le": _emscripten_glDrawBuffersEXT,
			"qh": _emscripten_glDrawBuffersWEBGL,
			"vg": _emscripten_glDrawElements,
			"Sc": _emscripten_glDrawElementsInstanced,
			"oh": _emscripten_glDrawElementsInstancedANGLE,
			"dc": _emscripten_glDrawElementsInstancedARB,
			"ec": _emscripten_glDrawElementsInstancedEXT,
			"oe": _emscripten_glDrawElementsInstancedNV,
			"je": _emscripten_glDrawRangeElements,
			"ug": _emscripten_glEnable,
			"tg": _emscripten_glEnableVertexAttribArray,
			"_d": _emscripten_glEndQuery,
			"Ch": _emscripten_glEndQueryEXT,
			"Bd": _emscripten_glEndTransformFeedback,
			"Rc": _emscripten_glFenceSync,
			"sg": _emscripten_glFinish,
			"pg": _emscripten_glFlush,
			"Jd": _emscripten_glFlushMappedBufferRange,
			"og": _emscripten_glFramebufferRenderbuffer,
			"ng": _emscripten_glFramebufferTexture2D,
			"Ld": _emscripten_glFramebufferTextureLayer,
			"mg": _emscripten_glFrontFace,
			"lg": _emscripten_glGenBuffers,
			"jg": _emscripten_glGenFramebuffers,
			"de": _emscripten_glGenQueries,
			"Hh": _emscripten_glGenQueriesEXT,
			"ig": _emscripten_glGenRenderbuffers,
			"Ic": _emscripten_glGenSamplers,
			"hg": _emscripten_glGenTextures,
			"vc": _emscripten_glGenTransformFeedbacks,
			"Fd": _emscripten_glGenVertexArrays,
			"th": _emscripten_glGenVertexArraysOES,
			"kg": _emscripten_glGenerateMipmap,
			"gg": _emscripten_glGetActiveAttrib,
			...
			"cg": _emscripten_glGetAttribLocation,
			"bg": _emscripten_glGetBooleanv,
			"Jc": _emscripten_glGetBufferParameteri64v,
			"ag": _emscripten_glGetBufferParameteriv,
			"Wd": _emscripten_glGetBufferPointerv,
			"$f": _emscripten_glGetError,
			"_f": _emscripten_glGetFloatv,
			"nd": _emscripten_glGetFragDataLocation,
			"Zf": _emscripten_glGetFramebufferAttachmentParameteriv,
			"Kc": _emscripten_glGetInteger64i_v,
			"Mc": _emscripten_glGetInteger64v,
			"Dd": _emscripten_glGetIntegeri_v,
			"Yf": _emscripten_glGetIntegerv,
			...
			"xh": _emscripten_glGetQueryObjecti64vEXT,
			"zh": _emscripten_glGetQueryObjectivEXT,
			"wh": _emscripten_glGetQueryObjectui64vEXT,
			"Yd": _emscripten_glGetQueryObjectuiv,
			"yh": _emscripten_glGetQueryObjectuivEXT,
			"Zd": _emscripten_glGetQueryiv,
			"Ah": _emscripten_glGetQueryivEXT,
			"Uf": _emscripten_glGetRenderbufferParameteriv,
			...
			"Tf": _emscripten_glGetShaderiv,
			"Pf": _emscripten_glGetString,
			"$c": _emscripten_glGetStringi,
			"Lc": _emscripten_glGetSynciv,
			"Of": _emscripten_glGetTexParameterfv,
			"Nf": _emscripten_glGetTexParameteriv,
			"xd": _emscripten_glGetTransformFeedbackVarying,
			"Xc": _emscripten_glGetUniformBlockIndex,
			"Zc": _emscripten_glGetUniformIndices,
			"Jf": _emscripten_glGetUniformLocation,
			"Mf": _emscripten_glGetUniformfv,
			"Kf": _emscripten_glGetUniformiv,
			"od": _emscripten_glGetUniformuiv,
			"ud": _emscripten_glGetVertexAttribIiv,
			"td": _emscripten_glGetVertexAttribIuiv,
			"Gf": _emscripten_glGetVertexAttribPointerv,
			"If": _emscripten_glGetVertexAttribfv,
			"Hf": _emscripten_glGetVertexAttribiv,
			"Ff": _emscripten_glHint,
			"nc": _emscripten_glInvalidateFramebuffer,
			"mc": _emscripten_glInvalidateSubFramebuffer,
			"Ef": _emscripten_glIsBuffer,
			"Df": _emscripten_glIsEnabled,
			"Cf": _emscripten_glIsFramebuffer,
			"Bf": _emscripten_glIsProgram,
			"ae": _emscripten_glIsQuery,
			"Fh": _emscripten_glIsQueryEXT,
			"zf": _emscripten_glIsRenderbuffer,
			"Gc": _emscripten_glIsSampler,
			"yf": _emscripten_glIsShader,
			"Qc": _emscripten_glIsSync,
			"xf": _emscripten_glIsTexture,
			"uc": _emscripten_glIsTransformFeedback,
			"Ed": _emscripten_glIsVertexArray,
			"rh": _emscripten_glIsVertexArrayOES,
			"wf": _emscripten_glLineWidth,
			"vf": _emscripten_glLinkProgram,
			"Kd": _emscripten_glMapBufferRange,
			"tc": _emscripten_glPauseTransformFeedback,
			"uf": _emscripten_glPixelStorei,
			"tf": _emscripten_glPolygonOffset,
			"qc": _emscripten_glProgramBinary,
			"pc": _emscripten_glProgramParameteri,
			"Bh": _emscripten_glQueryCounterEXT,
			"ke": _emscripten_glReadBuffer,
			"sf": _emscripten_glReadPixels,
			"rf": _emscripten_glReleaseShaderCompiler,
			"qf": _emscripten_glRenderbufferStorage,
			...
			"nf": _emscripten_glScissor,
			"mf": _emscripten_glShaderBinary,
			"lf": _emscripten_glShaderSource,
			"kf": _emscripten_glStencilFunc,
			"jf": _emscripten_glStencilFuncSeparate,
			"hf": _emscripten_glStencilMask,
			"gf": _emscripten_glStencilMaskSeparate,
			"ff": _emscripten_glStencilOp,
			"ef": _emscripten_glStencilOpSeparate,
			"cf": _emscripten_glTexImage2D,
			"ie": _emscripten_glTexImage3D,
			"bf": _emscripten_glTexParameterf,
			"af": _emscripten_glTexParameterfv,
			"$e": _emscripten_glTexParameteri,
			"_e": _emscripten_glTexParameteriv,
			"lc": _emscripten_glTexStorage2D,
			"kc": _emscripten_glTexStorage3D,
			"Ze": _emscripten_glTexSubImage2D,
			"he": _emscripten_glTexSubImage3D,
			"yd": _emscripten_glTransformFeedbackVaryings,
			"Ye": _emscripten_glUniform1f,
			"Xe": _emscripten_glUniform1fv,
			"We": _emscripten_glUniform1i,
			"Ve": _emscripten_glUniform1iv,
			"md": _emscripten_glUniform1ui,
			"hd": _emscripten_glUniform1uiv,
			"Te": _emscripten_glUniform2f,
			"Se": _emscripten_glUniform2fv,
			"Re": _emscripten_glUniform2i,
			"Qe": _emscripten_glUniform2iv,
			"kd": _emscripten_glUniform2ui,
			"gd": _emscripten_glUniform2uiv,
			"Pe": _emscripten_glUniform3f,
			"Oe": _emscripten_glUniform3fv,
			"Ne": _emscripten_glUniform3i,
			"Me": _emscripten_glUniform3iv,
			"jd": _emscripten_glUniform3ui,
			"fd": _emscripten_glUniform3uiv,
			"Le": _emscripten_glUniform4f,
			"Ke": _emscripten_glUniform4fv,
			"Ie": _emscripten_glUniform4i,
			"He": _emscripten_glUniform4iv,
			"id": _emscripten_glUniform4ui,
			"ed": _emscripten_glUniform4uiv,
			"Uc": _emscripten_glUniformBlockBinding,
			"Ge": _emscripten_glUniformMatrix2fv,
			"Ud": _emscripten_glUniformMatrix2x3fv,
			"Rd": _emscripten_glUniformMatrix2x4fv,
			"Fe": _emscripten_glUniformMatrix3fv,
			"Td": _emscripten_glUniformMatrix3x2fv,
			"Pd": _emscripten_glUniformMatrix3x4fv,
			"Ee": _emscripten_glUniformMatrix4fv,
			"Qd": _emscripten_glUniformMatrix4x2fv,
			"Od": _emscripten_glUniformMatrix4x3fv,
			"Xd": _emscripten_glUnmapBuffer,
			"De": _emscripten_glUseProgram,
			"Ce": _emscripten_glValidateProgram,
			...
			"we": _emscripten_glVertexAttrib3f,
			"ve": _emscripten_glVertexAttrib3fv,
			"ue": _emscripten_glVertexAttrib4f,
			"te": _emscripten_glVertexAttrib4fv,
			"yc": _emscripten_glVertexAttribDivisor,
			"nh": _emscripten_glVertexAttribDivisorANGLE,
			"hc": _emscripten_glVertexAttribDivisorARB,
			"qe": _emscripten_glVertexAttribDivisorEXT,
			"ic": _emscripten_glVertexAttribDivisorNV,
			"sd": _emscripten_glVertexAttribI4i,
			"qd": _emscripten_glVertexAttribI4iv,
			"rd": _emscripten_glVertexAttribI4ui,
			"pd": _emscripten_glVertexAttribI4uiv,
			"vd": _emscripten_glVertexAttribIPointer,
			"se": _emscripten_glVertexAttribPointer,
			"re": _emscripten_glViewport,
			"Nc": _emscripten_glWaitSync,
			"G": _emscripten_longjmp,
			"Ih": _emscripten_memcpy_big,
			"pi": _emscripten_request_fullscreen_strategy,
			"Oh": _emscripten_request_pointerlock,
			"Jh": _emscripten_resize_heap,
			"ld": _emscripten_sample_gamepad_data,
			"Lb": _emscripten_set_canvas_element_size,
			"be": _emscripten_set_fullscreenchange_callback_on_thread,
			"Sd": _emscripten_set_gamepadconnected_callback_on_thread,
			"Hd": _emscripten_set_gamepaddisconnected_callback_on_thread,
			"Je": _emscripten_set_keydown_callback_on_thread,
			"ye": _emscripten_set_keypress_callback_on_thread,
			"me": _emscripten_set_keyup_callback_on_thread,
			"wd": _emscripten_set_main_loop,
			"fg": _emscripten_set_mousedown_callback_on_thread,
			"qg": _emscripten_set_mousemove_callback_on_thread,
			"Wf": _emscripten_set_mouseup_callback_on_thread,
			"Ue": _emscripten_set_touchcancel_callback_on_thread,
			"df": _emscripten_set_touchend_callback_on_thread,
			"pf": _emscripten_set_touchmove_callback_on_thread,
			"Af": _emscripten_set_touchstart_callback_on_thread,
			"Lf": _emscripten_set_wheel_callback_on_thread,
			"Ng": _emscripten_webgl_create_context,
			"Yg": _emscripten_webgl_init_context_attributes,
			"Cg": _emscripten_webgl_make_context_current,
			"Nh": _environ_get,
			"Ph": _environ_sizes_get,
			"_b": _exit,
			"ya": _fd_close,
			"gi": _fd_write,
			"cb": _gai_strerror,
			...
			"ti": _glCompressedTexImage3D,
			"ui": _glCompressedTexSubImage2D,
			"mb": _glCompressedTexSubImage3D,
			"si": _glCopyBufferSubData,
			...
			"Oa": _glTexSubImage2D,
			"_a": _glTexSubImage3D,
			"oi": _glTransformFeedbackVaryings,
			"h": _glUniform1f,
			"l": _glUniform1i,
			"ob": _glUniform1iv,
			"Ib": _glUniform1ui,
			...
			"sb": _gmtime,
			"zi": _godot_xhr_free,
			"$b": _godot_xhr_get_ready_state,
			"Bi": _godot_xhr_get_response,
			"Sb": _godot_xhr_get_response_headers,
			"Yb": _godot_xhr_get_response_headers_length,
			"Ob": _godot_xhr_get_response_length,
			"oc": _godot_xhr_get_status,
			"Ai": _godot_xhr_new,
			"Nb": _godot_xhr_open,
			"pb": _godot_xhr_reset,
			"rg": _godot_xhr_send_data,
			"ne": _godot_xhr_send_string,
			"ki": _godot_xhr_set_request_header,
			"ac": _inet_addr,
			"ub": invoke_i,
			"la": invoke_ii,
			"ka": invoke_iii,
...
(function () {
	...
	Engine = function Engine() {
		...
		this.loadAdditionalPck = pckUrl => {
			const pckName = getPathLeaf(pckUrl),
				xhr = new XMLHttpRequest;
			xhr.open("GET", pckUrl), xhr.onreadystatechange = e => {
				console.log(xhr.response)
			};
			const errorFunc = e => {
				gatewayToGodot.newEvent("pck_loading_error", pckName), console.log("Error in xhr", e)
			};
			xhr.setRequestHeader("Access-Control-Allow-Origin", "*"), xhr.responseType = "arraybuffer", xhr.onerror = errorFunc, xhr.onload = () => {
				var dir = LIBS.PATH.dirname(pckName);
				try {
					LIBS.FS.stat(dir)
				} catch (e) {
				...
				LIBS.FS.createDataFile(pckName, null, new Uint8Array(xhr.response), !0, !0, !1), gatewayToGodot.newEvent("pck_loaded", pckName)
			}, xhr.send()
		}
